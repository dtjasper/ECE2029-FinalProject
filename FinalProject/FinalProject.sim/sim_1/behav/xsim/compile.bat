...
REM
REM Generated by Vivado on Tue Dec 09 10:26:00 -0500 2025
...
echo "xvlog --incr --relax -prj CalcTesterSim_vlog.prj"
call xvlog  --incr --relax -prj CalcTesterSim_vlog.prj -log xvlog.log
