...
REM
REM Generated by Vivado on Wed Dec 10 11:03:17 -0500 2025
...
echo "xvlog --incr --relax -prj BigCalcSim_vlog.prj"
call xvlog  --incr --relax -prj BigCalcSim_vlog.prj -log xvlog.log
